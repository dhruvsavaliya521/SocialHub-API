...
import {newFollow,unFollow} from "../controller/follow.controller.js";
...
router.route("/new-follow").post(verifyJWT,newFollow)
router.route("/un-follow").post(verifyJWT,unFollow) 
